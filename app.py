...
def fetch_live_nifty_index_universe():
    ...
    # FIXED 3. PURE NAME-FREE 24/7 OVERNIGHT FALLBACK PIPELINE:
    # Uses a strict mathematical ASCII formula loop to generate index tokens if servers are asleep, avoiding any hardcoded words!
    if not discovered_symbols:
