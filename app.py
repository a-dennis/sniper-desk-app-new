...
# Strategy constants mapped directly from your master plan.
PRICE_MIN = 50.0
PRICE_MAX = 500.0
BETA_MIN = 0.60
BETA_MAX = 1.20
...
# ==========================================
# 📊 REAL-TIME VALUE RETRIEVAL ENGINE (UN-BANNABLE HISTORY MODES MAPPED)
# ==========================================
live_price = 0.00
volume = 0
pe_val = 0.00
...
# Pre-calculate string variables safely outside the dataframes loops to eliminate open array errors
